<!-- BEGIN allostatik-part1 v0.3.7 sha256:c336e4142d56 -->
# Workflow
...
Run these at the start of every session, in order. Don't begin substantive work until all seven are done.
...
5. **Acknowledge the state in your own words.** Briefly restate what's done, what's open, and the immediate task. *Check (output):* the restatement is yours, not a copy of the handoff — putting it in your own words is what surfaces misunderstandings. *If it fails:* flag anything that doesn't line up with what you read.
