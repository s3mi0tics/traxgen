...
- **Explain testing concepts rather than assuming them.** Colby is new-ish to automation testing (finishing a Playwright course as of mid-2026). `pytest` is what this project uses; when a testing idea shows up — fixtures, property-based testing, fakes and injection, synchronization strategy — explain the concept alongside the code rather than treating it as background. Global preferences already say "teaching mode, calibrated to current capability"; this is the calibration datum for *this* domain, and it is time-limited — fade it as fluency shows.
